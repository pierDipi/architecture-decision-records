...
| Superseded by: | N/A                                                                                                                                                                                                                 |
| Tickets        | TBD                                                                                                                                                                                                                 |
| Other docs:    | [AI Gateway multi-tenancy](ODH-ADR-MS-0003-ai-gateway-tenancy.md), [Non-MaaS flow control](https://github.com/opendatahub-io/odh-model-controller/blob/main/internal/controller/resources/template/FLOW_CONTROL.md) |
...
These policy and migration choices are deferred; tenant-level ranges are not required for this ADR's initial
